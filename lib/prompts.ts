...
- Always use "use client" to the top of page.tsx and any other relevant files which use browser APIs or react hooks.
- Never add use client in backticks like this \`use client\`  but instead you should add it 
...
- If a generated JS string contains ' inside a '...' string, escape it as \' to avoid syntax errors.
